...
输出：backend/data/crosswoz/candidates/*.txt + candidates/README.md（仅指向仓库文档）

分桶说明见：docs/CrossWOZ语料说明.md
"""
...
def write_readme(out_dir: Path) -> None:
    content = """# CrossWOZ 导出候选

分桶说明、intent 映射与生成命令已集中到仓库文档：

**[docs/CrossWOZ语料说明.md](../../../../docs/CrossWOZ语料说明.md)**

请勿未改写整段合并进 `backend/data/nlu.yml`。
"""
